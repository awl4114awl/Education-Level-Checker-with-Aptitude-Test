...
A mock dataset is defined to simulate career data. This dataset includes the average salary, job outlook, required education, and a brief description for each career.
